...
echo '¿Qué ocurre cuando la variable previa cambia de valor?. ','<br>';
echo ' Si la definimos como estáticas la variable ira almacenando el valor tomado en la funcion hasta que se vuelva a actualizar la página'
